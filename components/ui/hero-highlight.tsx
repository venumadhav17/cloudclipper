...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn("group relative px-8 bg-black", containerClassName)}
      onMouseMove={handleMouseMove}
    >
      <div
        className='pointer-events-none bg-dot-thick-indigo-500 absolute inset-0 opacity-60'
        style={{
      ...
      />
      {/* <motion.div
        className='pointer-events-none absolute inset-0 opacity-0 transition duration-300 group-hover:opacity-100 dark:block'
        style={{
